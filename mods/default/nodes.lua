...
minetest.register_node("default:stone", {
	...
	groups = {cracky = 3, stone = 1, trade_value = 3,},
	drop = 'default:cobble',
	legacy_mineral = true,
...
minetest.register_node("default:cobble", {
	...
	groups = {cracky = 3, stone = 2, trade_value = 2,},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:sandstone", {
	...
	groups = {crumbly = 1, cracky = 3, trade_value = 2,},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:obsidian", {
	...
	sounds = default.node_sound_stone_defaults(),
	groups = {cracky = 1, level = 2, trade_value = 9,},
})
...
minetest.register_node("default:dirt", {
	...
	groups = {crumbly = 3, soil = 1, trade_value = 1},
...
minetest.register_node("default:dirt_with_grass", {
	...
	groups = {crumbly = 3, soil = 1, spreading_dirt_type = 1, trade_value = 2},
	drop = "default:dirt",
	sounds = default.node_sound_dirt_defaults({
...
minetest.register_node("default:sand", {
	...
	groups = {crumbly = 3, falling_node = 1, sand = 1, trade_value = 2,},
...
minetest.register_node("default:papyrus", {
	...
	groups = {snappy = 3, flammable = 2, trade_value = 3,},
	sounds = default.node_sound_leaves_defaults(),
...
for i = 1, #dye.dyes do
	...
	minetest.register_node("default:glass_" .. c, {
		description = dye.dyes[i][2] .. " Glass",
		drawtype = "glasslike_framed_optional",
		tiles = {"default_glass.png^[colorize:" .. c, "default_glass_detail.png^[colorize:" .. c},
		paramtype = "light",
	...
	minetest.register_craft({
		type = "shapeless",
		output = "default:glass_" .. c,
		recipe = {"group:glass", "dye:" .. dye.dyes[i][1]},
	})
end
