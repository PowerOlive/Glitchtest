...
-- formspec = apply armor screen, followed by:
-- armor crafting? (a la clothing/loom) + apply player armor.
-- and second screen: applying armor to stand.
local armor_stand_formspec = "size[8,7]" ..
	default.get_hotbar_bg(0, 3) ..
	jas0.exit_button() ..
	"button_exit[0,0;2,1;player_armor;Player Armor]" ..
...
minetest.register_node("3d_armor_stand:armor_stand", {
	...
	on_receive_fields = function(pos, formname, fields, sender)
		if fields.player_armor then
			minetest.after(0.1, function()
				local name = sender:get_player_name()
				minetest.show_formspec(name, "3d_armor:player_armor",
					"size[8,5.25]" ..
					jas0.exit_button() ..
