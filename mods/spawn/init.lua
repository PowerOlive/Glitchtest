...
spawn.on_spawn = function(player)
...
minetest.register_chatcommand("spawn", {
	description = "Return to static server spawn position!",
	privs = "interact",
	params = "",
	func = function(name, param)
		spawn.on_spawn(minetest.get_player_by_name(name))
		return true, "You are here."
	end,
})
